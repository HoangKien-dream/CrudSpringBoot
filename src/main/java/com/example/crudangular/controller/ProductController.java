...
import com.example.crudangular.service.ProductService;
import com.example.crudangular.specification.OrderSpecification;
import com.example.crudangular.specification.ProductSpecification;
...
//        products.add(new Product("MacBook Pro 13 M1 16GB 256GB - Silver", 36000000, "https://product.hstatic.net/1000026716/product/macbook_pro_13_m1_16gb_256gb_-_silver_78a680b55d3943f1985755150ae11f98.png", "Bên cạnh chiếc MacBook Air mới được ra mắt trong cùng sự kiện One more thing T11 2020 Apple cũng  giới thiệu dòng MacBook Pro 13 inch 2020 hoàn toàn mới.", 1, 1));
//        products.add(new Product("MacBook Pro 13 M1 16GB 512GB - Grey", 41000000, "https://product.hstatic.net/1000026716/product/macbook_pro_13_m1_16gb_512gb_-_grey_fec311b198eb4f60abd8db8c9b08d47f.png", "MacBook Pro 13 16GB sử dụng bộ vi xử lý Apple M1 giúp tốc độ và mạnh mẽ hơn bao giờ hết", 1, 1));
//        products.add(new Product("MacBook Air M1 7GPU 16GB 512GB - Gold", 35000000, "https://product.hstatic.net/1000026716/product/macbook_air_m1_7gpu_16gb_512gb_-_gold_aae4fc1f983240909c80c4b19fa4001c.png", "Trong cùng 1 năm MacBook Air 2020 mới được Apple nâng cấp ra mắt với sự xuất hiện của con Chip Apple M1 được phát triển với kiến trúc ARM mới, nhanh hơn 98% PC, pin 18 giờ.", 1, 1));
